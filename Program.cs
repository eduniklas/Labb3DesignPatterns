...
namespace Labb3DesignPatterns
{
    ...
    internal class Cappocino : IWarmDrink
    {
        public void Consume()
        {
            Console.WriteLine("Cappocino is served.");
        }
    }
    ...
    }internal class CoffeeFactory : IWarmDrinkFactory
    {
        public IWarmDrink Prepare(int total)
        {
            Console.WriteLine($"Pouring {total} ml freshly brewed coffee in your cup");
            return new Coffee();
        }
    }
    internal class CappocinoFactory : IWarmDrinkFactory
    {
        public IWarmDrink Prepare(int total)
        {
            Console.WriteLine($"Pouring {total} ml of cappocino in your cup");
            return new Cappocino();
        }
    }
    internal class HotChocolateFactory : IWarmDrinkFactory
    {
        public IWarmDrink Prepare(int total)
        {
            Console.WriteLine($"Pouring {total} ml of hot chocolate in your cup");
